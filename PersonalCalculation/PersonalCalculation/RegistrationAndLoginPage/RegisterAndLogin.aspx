<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegisterAndLogin.aspx.cs" Inherits="PersonalCalculation.RegistrationAndLoginPage.RegisterAndLogin" %>
        ...
        <nav class="navbar navbar-default navbar-fixed-top shadow_B">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand zoom-effect" style="padding-left: 30px; font-size: 25px;" href="#">Login Page </a>
                </div>
        ...
        <div style="background-color: #E8EAED">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <%
                        string showReg = ConfigurationManager.AppSettings["ShowRegForm"].ToString();
                    ...
                    <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 col-lg-offset-1">
                        ...
                        <br />
                        <br />
                        <h2> Tanvir sir is the best teacher among the world </h2>
        ...
        $('#btnLogin').click(function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $('#loaderDiv').hide();
                    //window.location.href = "http://localhost:49649/Home/Index";
                },
