...
namespace CIS.Lib.DALC
{
    ...
    //
    // The Donors class represents a Projects table
    //
    //****************************************************************************
    public class Projects : DAOBase
    {
        ...
        public bool Load(int id)
        {
            ...
            string cmdText = @"SELECT * FROM Projects WHERE ID = @0";
        ...
        {
            string cmdText = @"INSERT INTO Projects (Name,OrganizationID) 
							VALUES (@0,@1)";
        ...
        {
            string cmdText = @"UPDATE Projects SET Name=@0, OrganizationID=@1 WHERE ID=@2";
        ...
        {
            string cmdText = @"DELETE FROM Projects WHERE ID=@0";
