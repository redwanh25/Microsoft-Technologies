<%@ Page Title="" Language="C#" MasterPageFile="~/BestowerSoft.Master" AutoEventWireup="true" CodeBehind="ListExpenses.aspx.cs" Inherits="BFWeb.ListExpenses" %>
							...
							<!-- this is content table comes in -->
                                    ...
                                    <TABLE width="100%" border="0" cellspacing="1" cellpadding="2">
								        ...
								        <td class="bannertext" width="1%">&nbsp;</td>
							                <td class="bannertext" nowrap onclick="javascript:sortColumn(event);">&nbsp;<u style='CURSOR: hand; TEXT-DECORATION: underline'>Project</u>&nbsp;</td>
									...
									<asp:repeater id="repParent" Runat="server">									    
										<ItemTemplate>
											<tr class='<%# DataBinder.Eval(Container.DataItem, "TRClass") %>' >											
        									    ...
        									    <td class="valuetextsmall"><%# DataBinder.Eval(Container.DataItem, "ProjectName") %></td>
											    ...
											    <td class="valuetextsmall"><%# DataBinder.Eval(Container.DataItem, "ExpenseDate", "{0:MM/dd/yyyy}") %> </td>
