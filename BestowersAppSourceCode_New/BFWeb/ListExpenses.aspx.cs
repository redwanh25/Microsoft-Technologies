...
namespace BFWeb
{
    public partial class ListExpenses : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                // get organiation id of the logged in user
                string orgId = AppSecurity.GetUserOrganization();
                string whereClause = " e.OrganizationID = " + orgId;
                ...
                whereClause = whereClause + " AND Year(e.ExpenseDate) = " + year;
                tbYear.Text = year;
        ...
        protected void btnGetExepenses_Click(object sender, EventArgs e)
        {
            ...
            {
                whereClause = whereClause + " AND Year(e.ExpenseDate) = " + strYear;
            }
