<%@ Page Title="" ValidateRequest="false" Language="C#" MasterPageFile="~/BestowerSoft.Master" AutoEventWireup="true" CodeBehind="TemplateDetails.aspx.cs" Inherits="BFWeb.TemplateDetails" %>
					                ...
					                <td class="navback">
						                <table width="100%">							
							                ...
							                <tr class="valuetextsmall">
								                <td vAlign="top" noWrap align="right">Template Name:</td>
								                <td class="valuecell" noWrap align="left"><asp:textbox id="tbTemplateName" Runat="server"></asp:textbox></td>
							                </tr>

							                <tr class="valuetextsmall">
								                <td vAlign="top" noWrap align="right">Template Content:</td>
								                <td class="valuecell" noWrap align="left"><asp:textbox id="tbTemplateContent" Runat="server" TextMode="MultiLine" Height="400" width="600"></asp:textbox></td>
							                </tr>							                
