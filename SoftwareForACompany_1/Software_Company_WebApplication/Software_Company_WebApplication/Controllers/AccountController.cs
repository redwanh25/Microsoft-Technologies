...
using Software_Company_WebApplication.Providers;
using Software_Company_WebApplication.Results;
...
namespace Software_Company_WebApplication.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        public async Task<IHttpActionResult> Register(RegisterBindingModel model)
        {
            ...
            var user = new ApplicationUser() { UserName = model.UserName, Email = model.Email, PhoneNumber=model.PhoneNumber, EmployeeCode = model.EmployeeCode };
