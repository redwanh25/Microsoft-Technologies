...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    ...
    <div class="container">
            ...
            <div class="tz-gallery">
                <div class="row">
                    <a class="lightbox" href="../Image/WebDevelopmentPic.jpg">
                        <img src="../Image/WebDevelopmentPic.jpg" class="img-responsive" style="border-radius: 10px" />
                    </a>
                </div>
            </div>
        ...
        <br />
        <div class="row" align="center">
            <h1 style="color: orange">Do you need web developers?</h1>
            <hr style="border: 2px solid; color: lightgray; width: 200px">
            <p style="font-family: Impact; font-size: 40px">Indpro is an IT partner with resources in web development.</p>
            <h3 style="font-family: Calibri">We are a Swedish company with over twelve years of experience in IT delivery. 
        ...
        <div class="row">
            <div class="col-sm-9 col-md-12 col-lg-9 col-lg-offset-2 col-sm-offset-1">
                <h1><b>Some of the technologies we are skilled in:</b></h1>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-10 col-md-12 col-lg-10 col-lg-offset-1 col-sm-offset-1">
                <h1 style="color: orange; font-family: Impact" class="text-center">How does it work?</h1>
                <br />
                ...
                <br />
                <h3 style="font-size: 21px">We are experts at leading remote teams in web development. Regardless of whether our developers sit with us or with you, we ensure that cooperation flows smoothly. We use agile management tools that give our clients full insight into the ongoing work.</h3>
                <br />
                <h3 style="font-size: 21px">A Swedish technical project manager is always onboard at the start of a new project. This is an efficient way of minimizing the risk of misunderstandings associated with the purpose and design of the solution.</h3>
            </div>
        </div>
    </div>
