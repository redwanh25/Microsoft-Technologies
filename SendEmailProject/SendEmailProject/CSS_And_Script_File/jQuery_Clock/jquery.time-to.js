...
(function (factory) {
    ...
    //============ Custom =============
    var d = new Date();
    var utcNow = new Date(d.getUTCFullYear(), d.getUTCMonth(), d.getUTCDate(), d.getUTCHours(), d.getUTCMinutes(), d.getUTCSeconds(), d.getUTCMilliseconds()).getTime();
    //=================================
...
/* eslint-disable no-multi-spaces */
    ...
    function init(sec, force) {
        ...
        if (isInterval || force) {
            //============ Custom =============
            data.ttStartTime = utcNow; //Date.now();
            //=================================
