...
namespace CIS.Lib.Utils {
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="CPSServicesSoap", Namespace="http://agmanager.info/")]
    public partial class CPSServices : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public CPSServices() {
            this.Url = "http://localhost/CpsWS/CPSServices.asmx";
        }
