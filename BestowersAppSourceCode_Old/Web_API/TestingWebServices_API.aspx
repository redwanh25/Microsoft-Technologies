<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TestingWebServices_API.aspx.cs" Inherits="Web_API.TestingWebServices_API" %>
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $.each(data, function (index, val) {
                            ...
                            tbody.append('<tr class="h4"> <td>' + val.MemberID + '</td> <td>' + val.FirstName +
