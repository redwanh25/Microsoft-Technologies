<%@ Page Title="" Language="C#" MasterPageFile="~/BFWeb.Master" AutoEventWireup="true" CodeBehind="ExpenseDetails.aspx.cs" Inherits="BFWeb.ExpenseDetails" %>
					                ...
					                <td class="navback">
						                <table width="100%">							
							                ...
							                <tr class="valuetextsmall">
								                <td vAlign="top" noWrap align="right">Expense Category:</td>
								                <td class="valuecell" noWrap align="left"><asp:dropdownlist id="ddlExpenseCategory" runat="server" DataTextField="Name" DataValueField="ID"></asp:dropdownlist></td>
							                </tr>
							                <tr class="valuetextsmall">
