    ...
    public partial class ExpenseDetails : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                CIS.Lib.DALC.ExpenseCategory d = new CIS.Lib.DALC.ExpenseCategory();
                DataSet dsD = d.Find(AppSetting.GetConnString(), "ExpenseCategory", string.Empty, " ORDER BY Name");
                ddlExpenseCategory.DataSource = dsD.Tables[0].DefaultView;
                ...
                if (AppSecurity.GetUserRole() != "1")
                {
                    ...
                    ddlExpenseCategory.Enabled = false;
        ...
        protected void LoadData(int id)
        {
            ...
            foreach (ListItem li in ddlExpenseCategory.Items)
            {
                if (d.ExpenseCategoryID.ToString() == li.Value)
                    li.Selected = true;
            }
        ...
        protected void btnOK_Click(object sender, EventArgs e)
        {
            ...
            int expenseCategoryId = Convert.ToInt32(ddlExpenseCategory.Text);
