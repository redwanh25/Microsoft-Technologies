<%@ Page Title="" Debug="true" Language="C#" MasterPageFile="~/BFWeb.Master" AutoEventWireup="true" CodeBehind="ListDonations.aspx.cs" Inherits="BFWeb.ListDonations" %>
							...
							<!-- this is content table comes in -->
                                    ...
                                    <TABLE width="100%" border="0" cellspacing="1" cellpadding="2">
								        ...
								        <td class="bannertext" width="1%">&nbsp;</td>
							                ...
							                <td class="bannertext" nowrap><asp:CheckBox ID="cbToggleAll" runat="server" />Send Receipt?</td>
							            </tr>
                                        </thead>
									<asp:repeater id="repParent" Runat="server">									    
										<ItemTemplate>
											<tr class='<%# DataBinder.Eval(Container.DataItem, "TRClass") %>' >											
											    ...
											    <td class="valuetextsmall"><%# DataBinder.Eval(Container.DataItem, "DonationDate") %> </td>
											    ...
											    <td class="valuetextsmall"> <asp:CheckBox ID="cbSendReceipt" runat="server"></asp:CheckBox></td>
